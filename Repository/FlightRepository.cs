...
namespace FlightManagementCompany.Repository
{
    public class FlightRepository : IFlightRepository // Represents a repository for managing flight entities in the flight management system.
    {
        ...
        public void Save() => _ctx.SaveChanges();// Saves changes made to the database context. This method is used to persist any changes made to the flight entities in the database, such as adding, updating, or deleting records.
    }
}
